...
class CustomUser(AbstractUser):
    ...
    rank = models.CharField(max_length=50, default="Starter")
    wallet_balance = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    total_referral_income = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    total_downlines = models.PositiveIntegerField(default=0)
        ...
        if not self.referral_id:
            while True:
                ...
                if not CustomUser.objects.filter(referral_id=code).exists():
                    ...
                    self.referral_link = (
                        f"https://ynexportindia.onrender.com/register/?ref={code}"
                    )
                    break
